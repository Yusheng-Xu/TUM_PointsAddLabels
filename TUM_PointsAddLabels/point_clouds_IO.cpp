...
//IO::saveOBJFile2
void
saveOBJFile2(string path_name, Eigen::Vector3f vertices_points, int input_type, Eigen::Vector2i lines_indexs, Eigen::Vector4i faces_indexs)
{
	//Settings
	int vertices_num;
	int lines_num;
	...
	//Initialization
	vertices_num=vertices_points.size();
	lines_num=lines_indexs.size();
	faces_num=faces_indexs.size();
}
